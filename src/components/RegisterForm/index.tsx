    ...
    <form className="text-black">
      <div className="flex flex-col gap-4">
        <div>
          ...
          <input
            id="fullName"
            className={`w-full border rounded-xs px-1 mt-1 focus:outline-none focus:ring-2 ${errors.nomeCompleto ? "border-error focus:ring-red-400" : "border-border focus:ring-accent"}`}
            type="text"
            {...register("nomeCompleto")}
          />
          {errors.nomeCompleto && <p className="text-error text-xs mt-1">{errors.nomeCompleto.message}</p>}
        </div>
        ...
        <div>
          ...
          <input
            ...
            {...register("cpf")}
          />
          {errors.cpf && <p className="text-error text-xs mt-1">{errors.cpf.message}</p>}
        </div>

        <div>
          <label htmlFor="birthday" className="text-xs text-gray-600">
            Data de nascimento*
          </label>
          <input
            id="birthday"
            className={`w-full border rounded-xs px-1 mt-1 focus:outline-none focus:ring-2 ${errors.dataNascimento ? "border-error focus:ring-red-400" : "border-border focus:ring-accent"}`}
            type="date"
            {...register("dataNascimento")}
          />
          {errors.dataNascimento && <p className="text-error text-xs mt-1">{errors.dataNascimento.message}</p>}
        </div>

        <div>
          <label htmlFor="cellphone" className="text-xs text-gray-600">
            Celular*
          </label>
          <input
            id="cellphone"
            ...
            {...register("cellphone")}
          />
          {errors.cellphone && <p className="text-error text-xs mt-1">{errors.cellphone.message}</p>}
        </div>
        ...
        <button
          className="bg-accent text-white font-semibold uppercase rounded-md py-3 transition-all hover:bg-accent-hover disabled:opacity-50 w-full cursor-pointer"
